              ...
              <a href="sections" class="card info-card sales-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>3</h6>
                      <span class="text-muted small pt-2 ps-1">Inactive Students</span>
                    </div>
                  </div>
                </div>
              </a>
          ...
          <div class="col-md-12">
            <div class="card">
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <a data-bs-toggle="modal" class="float-end btn btn-primary btn-sm" data-bs-target="#addStudentModal" ><i class="fa fa-plus"></i> Add Student</a>
                </div>
                <div class="card-body">
