              ...
              <a href="#" class="card info-card sales-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>3</h6>
                      <span class="text-muted small pt-2 ps-1">Graduates</span>
                    </div>
                  </div>
                </div>
              </a>
          ...
          <div class="col-md-12">
            <div class="card">
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <a href="student-add" class="float-end btn btn-primary btn-sm mb-1"><i class="fa fa-plus"></i> Add Student</a>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-hover" id="datatable">
                        ...
                        <tbody>
                          <tr>
                              ...
                              <td>
                                  <a href="student-view" class="btn btn-success btn-sm mb-1"><i class="fa fa-eye"></i></a>
                                  <a href="student-edit" class="btn btn-primary btn-sm mb-1"><i class="fa fa-edit"></i></a>
                              </td>
                          </tr>
                          <tr>
                              <th scope="row">2</th>
